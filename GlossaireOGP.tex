...
\def{Approvisionnement automatique}
{
	Date fixe, quantité fixe
	}{23/10/2006 : 3 - 6}

\def{Approvisionnement au point de commande}
{
	Date variable, quantité fixe
	}{23/10/2006 : 3 - 6}

\def{Approvisionnement par Achats opportunistes}
{
	Date variable, quantité variable
	}{23/10/2006 : 3 - 7}

\def{Approvisionnement par re-complètement}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/lecalcul.htm}{Calcul de charge}}
{
	On calcule la charge correspondant au plan de fabrication jalonné. Le  \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/jalonnem.htm}{jalonnement} étant fait à  \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/capacit%C3%A9limit%C3%A9e.htm}{capacité illimité TODO}, des surcharges sont possibles sur certaines ressources pour une période donnée. Dans l’éventualité d’une surcharge, il faut réaliser un \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/lajustem.htm}{ajustement de charge}.
	}{}
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/le_chevauchement.htm}{Chevauchement d’opérations}}
{
...
\def{Chevauchement d’ordres de fabrication}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_controle_de_gestion/lecontrole_de_gestion.htm}{Contrôle de gestion}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/lencours.htm}{En-cours}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_commercial_achats/fonction_commerciale.htm}{Fonction commerciale et achat}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/L_etude_industrialisation/fonction_etude_indus.htm}{Fonction étude industrialisation}}
{
...
Cette fonction est à l’origine de la création de la \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/L_etude_industrialisation/labasededonn%C3%A9es.htm}{base de données techniques TODO}, et participe en grande partie à son évolution.
	}{}
	
\def{Fonction gestion de production}
{
...
\def{Gamme d’ordonnancement}
{
	La gamme d’ordonnancement constitue le document essentiel de fabrication, détaillant l'analyse du mode opératoire d'élaboration d'un \href{http://gpr.insa-lyon.fr/supgedem/Home/glossaire/garticle.htm}{article}.
...
\def{Gestion scientifique des stocks}
{
...
Le jalonnement est effectué dans la plupart des cas à \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/capacit%C3%A9limit%C3%A9e.htm}{capacité illimitée TODO}.
	}{8/11/2006 : 11}
		
\def{Juste à temps (JAT)}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/le_lancement.htm}{Lancement}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/leslots.htm}{Lot}}
{
...
\def{Macro Gamme}
{
	Ensemble de phases sur des ressources critique.\\ 	On indique le nombre d’heures passées sur une ressource critique pour une famille de produits. Ceci implique la définition des profils de charge.	
	}{}
...
\def{Nomenclature Bureau des méthodes}
{
	Structure arborescente sur les articles descriptibles graphiquement.
	}{13/11/2006 : 8}
	
\def{Nomenclature Bureau d’études}
{
	Liste sur un seul niveau de dossiers sur les articles descriptifs.
	}{13/11/2006 : 8}

\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/lesordres.htm}{Ordre}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/La_gestion_de_production/Le_pilotage_des_taches_et_des_ressources/ordonnac.htm}{Ordonnancer}}
{
...
\def{Poste de charge}
{
	...
	(norme ISO 8402).\\
	C’est un ensemble de machines ou de postes de production ayant les mêmes capabilités et les mêmes performances, donc \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/linterchangeabilit%C3%A9.htm}{interchangeables}. Il faut que ces postes appartiennent à la même entité géographique et à la même entité de gestion.
	}{}


\def{Poste de travail}
{
	Le poste de travail est un emplacement défini sur lequel un ou plusieurs ouvriers exécutent un travail, avec ou sans  HYPERLINK "http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/machines.htm" MACHINE.\\
	(norme AFNOR NF X50-310 ).
	Les postes peuvent être :
	\begin{itemize}
	\item Manuels. L'homme y tient une place prépondérante. On y trouve une grande \href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/flexibilt%C3%A9.htm}{flexibilité}. 
...
\def{Processus d’approvisionnement et de stockage}
{
	
	}{23/10/2006 : 1}

\def{Processus distribution}
{
	
	}{}

\def{Processus production}
{
	
	}{}

\def{Processus relation fournisseur}
{
	
	}{}


\def{Production en ligne}
{
	Production en ligne, continue, flow shop
	}{07/11/2006 : 7}

\def{Production discontinue}
{
	Production discontinue, par lots, en section homogène, job shop
	}{07/11/2006 : 7}

\def{Production par îlots}
{
	Production par îlots, organisation mixte
	}{07/11/2006 : 8}

\def{Production suggeree}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/ressources.htm}{Ressource}}
{
...
\def{\href{http://gpr.insa-lyon.fr/supgedem/Home/Le_monde_industriel/L_entreprise/Le_systeme_physique_de_production/le_SMED.htm}{SMED}}
{
	...
	La transformation : Moyennant investissement, les opérations internes restantes seront changées en opérations externes. Par exemple, un moule qui était préchauffé sur une machine, pourra être préchauffé dans une étuve. En investissant dans une étuve, le temps de préchauffage n’intervient plus lors du changement de série.
	La réduction de temps de réalisation des opérations internes restantes. Il s’agit d’engager enfin des actions pour que les opérations internes prennent le moins de temps possible. Les machines pourront par exemple être équipées de serrages rapides d’outils.
...
\def{Stock disponible}
{
	$ = stock réel + entrées prévisionnelles$
	}{}
	
\def{Stock libre ou disponible}
{
...
\def{Taux de service de l’entreprise}
{
	Taux de service de l’entreprise
	}{16/10/2006 : 4}
	
\def{Temps de transfert}
{
